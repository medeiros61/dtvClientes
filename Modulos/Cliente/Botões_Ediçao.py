...
def criarbotoes(Viewer):
    ...
    entry_Nome_empresa = ctk.CTkEntry(Viewer.tab("Cliente"), width=50)

    label_Nome_empresa.grid(row=0, column=0, padx=10, pady=5, sticky="nsew")
    entry_Nome_empresa.grid(row=0, column=1, padx=10, pady=5, sticky="nsew")


    label_CNPJ = ctk.CTkLabel(Viewer.tab("Cliente"), text="CNPJ")
    entry_CNPJ = ctk.CTkEntry(Viewer.tab("Cliente"), width=50)

    label_CNPJ.grid(row=1, column=0, padx=10, pady=5, sticky="nsew")
    entry_CNPJ.grid(row=1, column=1, padx=10, pady=5, sticky="nsew")


    label_Estado = ctk.CTkLabel(Viewer.tab("Cliente"), text="Estado")
    entry_Estado = ctk.CTkEntry(Viewer.tab("Cliente"), width=50)

    label_Estado.grid(row=2, column=0, padx=10, pady=5, sticky="nsew")
    entry_Estado.grid(row=2, column=1, padx=10, pady=5, sticky="nsew")


    label_Municpio = ctk.CTkLabel(Viewer.tab("Cliente"), text="Município")
    entry_Municpio = ctk.CTkEntry(Viewer.tab("Cliente"), width=50)

    label_Municpio.grid(row=3, column=0, padx=10, pady=5, sticky="nsew")
    entry_Municpio.grid(row=3, column=1, padx=10, pady=5, sticky="nsew")


    label_Atividade = ctk.CTkLabel(Viewer.tab("Cliente"), text="Atividade")
    entry_Atividade = ctk.CTkEntry(Viewer.tab("Cliente"), width=50)

    label_Atividade.grid(row=4, column=0, padx=10, pady=5, sticky="nsew")
    entry_Atividade.grid(row=4, column=1, padx=10, pady=5, sticky="nsew")


    label_Data_abertura_ = ctk.CTkLabel(Viewer.tab("Cliente"), text="Data abertura (dd/mm/aaaa)")
    entry_Data_abertura_ = ctk.CTkEntry(Viewer.tab("Cliente"), width=50)
    ...
    entry_Ativo = ctk.CTkEntry(Viewer.tab("Cliente"), width=50)

    label_Ativo.grid(row=6, column=0, padx=10, pady=5, sticky="nsew")
    entry_Ativo.grid(row=6, column=1, padx=10, pady=5, sticky="nsew")


    label_Link_WhatsApp = ctk.CTkLabel(Viewer.tab("Cliente"), text="Link WhatsApp")
    entry_Link_WhatsApp = ctk.CTkEntry(Viewer.tab("Cliente"), width=50)

    label_Link_WhatsApp.grid(row=7, column=0, padx=10, pady=5, sticky="nsew")
    entry_Link_WhatsApp.grid(row=7, column=1, padx=10, pady=5, sticky="nsew")


    label_Formas_de_tributao = ctk.CTkLabel(Viewer.tab("Gerais"), text="Formas de tributação")
    entry_Formas_de_tributao = ctk.CTkEntry(Viewer.tab("Gerais"), width=50)
    ...
    entry_Folha_de_pagamento = ctk.CTkEntry(Viewer.tab("Gerais"), width=50)
    ...
    entry_Domiclio_eletrnico = ctk.CTkEntry(Viewer.tab("Gerais"), width=50)
    ...
    entry_Certificado_digital = ctk.CTkEntry(Viewer.tab("Gerais"), width=50)
    ...
    entry_Cdigo_e_cac = ctk.CTkEntry(Viewer.tab("Federais"), width=50)

    label_Cdigo_e_cac.grid(row=0, column=0, padx=10, pady=5, sticky="nsew")
    entry_Cdigo_e_cac.grid(row=0, column=1, padx=10, pady=5, sticky="nsew")


    label_Senha_EAC = ctk.CTkLabel(Viewer.tab("Federais"), text="Senha EAC")
    entry_Senha_EAC = ctk.CTkEntry(Viewer.tab("Federais"), width=50)

    label_Senha_EAC.grid(row=1, column=0, padx=10, pady=5, sticky="nsew")
    entry_Senha_EAC.grid(row=1, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Cdigo_Simples.grid(row=2, column=0, padx=10, pady=5, sticky="nsew")
    entry_Cdigo_Simples.grid(row=2, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Nmero_de_livros_ECD.grid(row=3, column=0, padx=10, pady=5, sticky="nsew")
    entry_Nmero_de_livros_ECD.grid(row=3, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Ano_Nmero_de_livros_ECD.grid(row=4, column=0, padx=10, pady=5, sticky="nsew")
    entry_Ano_Nmero_de_livros_ECD.grid(row=4, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Nmero_de_livros_ECF.grid(row=5, column=0, padx=10, pady=5, sticky="nsew")
    entry_Nmero_de_livros_ECF.grid(row=5, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Ano_Nmero_de_livros_ECF.grid(row=6, column=0, padx=10, pady=5, sticky="nsew")
    entry_Ano_Nmero_de_livros_ECF.grid(row=6, column=1, padx=10, pady=5, sticky="nsew")


    label_Estado = ctk.CTkLabel(Viewer.tab("Estaduais"), text="Estado")
    entry_Estado = ctk.CTkEntry(Viewer.tab("Estaduais"), width=50)

    label_Estado.grid(row=0, column=0, padx=10, pady=5, sticky="nsew")
    entry_Estado.grid(row=0, column=1, padx=10, pady=5, sticky="nsew")


    label_UF = ctk.CTkLabel(Viewer.tab("Estaduais"), text="UF")
    entry_UF = ctk.CTkEntry(Viewer.tab("Estaduais"), width=50)

    label_UF.grid(row=1, column=0, padx=10, pady=5, sticky="nsew")
    entry_UF.grid(row=1, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Inscrio_estadual.grid(row=2, column=0, padx=10, pady=5, sticky="nsew")
    entry_Inscrio_estadual.grid(row=2, column=1, padx=10, pady=5, sticky="nsew")


    label_Credenciamento_NFE = ctk.CTkLabel(Viewer.tab("Estaduais"), text="Credenciamento NFE")
    entry_Credenciamento_NFE = ctk.CTkEntry(Viewer.tab("Estaduais"), width=50)

    label_Credenciamento_NFE.grid(row=3, column=0, padx=10, pady=5, sticky="nsew")
    entry_Credenciamento_NFE.grid(row=3, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Nmero_CSC.grid(row=4, column=0, padx=10, pady=5, sticky="nsew")
    entry_Nmero_CSC.grid(row=4, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Site_caixa_postal.grid(row=5, column=0, padx=10, pady=5, sticky="nsew")
    entry_Site_caixa_postal.grid(row=5, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Livros_Fiscais_Entrada_Ano_Nmero.grid(row=6, column=0, padx=10, pady=5, sticky="nsew")
    entry_Livros_Fiscais_Entrada_Ano_Nmero.grid(row=6, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Livros_Fiscais_Inventrio_Ano_Nmero.grid(row=7, column=0, padx=10, pady=5, sticky="nsew")
    entry_Livros_Fiscais_Inventrio_Ano_Nmero.grid(row=7, column=1, padx=10, pady=5, sticky="nsew")


    label_Inscrio_municipal = ctk.CTkLabel(Viewer.tab("Municipais"), text="Inscrição municipal")
    entry_Inscrio_municipal = ctk.CTkEntry(Viewer.tab("Municipais"), width=50)

    label_Inscrio_municipal.grid(row=0, column=0, padx=10, pady=5, sticky="nsew")
    entry_Inscrio_municipal.grid(row=0, column=1, padx=10, pady=5, sticky="nsew")


    label_Site = ctk.CTkLabel(Viewer.tab("Municipais"), text="Site")
    entry_Site = ctk.CTkEntry(Viewer.tab("Municipais"), width=50)

    label_Site.grid(row=1, column=0, padx=10, pady=5, sticky="nsew")
    entry_Site.grid(row=1, column=1, padx=10, pady=5, sticky="nsew")


    label_Login = ctk.CTkLabel(Viewer.tab("Municipais"), text="Login")
    entry_Login = ctk.CTkEntry(Viewer.tab("Municipais"), width=50)

    label_Login.grid(row=2, column=0, padx=10, pady=5, sticky="nsew")
    entry_Login.grid(row=2, column=1, padx=10, pady=5, sticky="nsew")


    label_Senha = ctk.CTkLabel(Viewer.tab("Municipais"), text="Senha")
    entry_Senha = ctk.CTkEntry(Viewer.tab("Municipais"), width=50)

    label_Senha.grid(row=3, column=0, padx=10, pady=5, sticky="nsew")
    entry_Senha.grid(row=3, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Demais_senhas.grid(row=4, column=0, padx=10, pady=5, sticky="nsew")
    entry_Demais_senhas.grid(row=4, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Senha_Abertura_Processos.grid(row=5, column=0, padx=10, pady=5, sticky="nsew")
    entry_Senha_Abertura_Processos.grid(row=5, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Observaes.grid(row=6, column=0, padx=10, pady=5, sticky="nsew")
    entry_Observaes.grid(row=6, column=1, padx=10, pady=5, sticky="nsew")


    label_Alvara_de_funcionamento = ctk.CTkLabel(Viewer.tab("Societário"), text="Alvara de funcionamento")
    entry_Alvara_de_funcionamento = ctk.CTkEntry(Viewer.tab("Societário"), width=50)
    ...
    entry_Alvara_sanitrio = ctk.CTkEntry(Viewer.tab("Societário"), width=50)
    ...
    label_Licena_ambiental = ctk.CTkLabel(Viewer.tab("Societário"), text="Licença ambiental")
    entry_Licena_ambiental = ctk.CTkEntry(Viewer.tab("Societário"), width=50)

    label_Licena_ambiental.grid(row=4, column=0, padx=10, pady=5, sticky="nsew")
    entry_Licena_ambiental.grid(row=4, column=1, padx=10, pady=5, sticky="nsew")
    ...
    entry_Bombeiros = ctk.CTkEntry(Viewer.tab("Societário"), width=50)
    ...
    entry_Folha_de_pagto = ctk.CTkEntry(Viewer.tab("Departamento pessoal"), width=50)
    ...
    entry_Prolabore = ctk.CTkEntry(Viewer.tab("Departamento pessoal"), width=50)
    ...
    entry_Sistema = ctk.CTkEntry(Viewer.tab("BPO"), width=50)

    label_Sistema.grid(row=0, column=0, padx=10, pady=5, sticky="nsew")
    entry_Sistema.grid(row=0, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Usurio = ctk.CTkLabel(Viewer.tab("BPO"), text="Usuário")
    entry_Usurio = ctk.CTkEntry(Viewer.tab("BPO"), width=50)

    label_Usurio.grid(row=2, column=0, padx=10, pady=5, sticky="nsew")
    entry_Usurio.grid(row=2, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Senha_simples.grid(row=3, column=0, padx=10, pady=5, sticky="nsew")
    entry_Senha_simples.grid(row=3, column=1, padx=10, pady=5, sticky="nsew")


    label_Banco_1 = ctk.CTkLabel(Viewer.tab("BPO"), text="Banco 1")
    entry_Banco_1 = ctk.CTkEntry(Viewer.tab("BPO"), width=50)

    label_Banco_1.grid(row=4, column=0, padx=10, pady=5, sticky="nsew")
    entry_Banco_1.grid(row=4, column=1, padx=10, pady=5, sticky="nsew")


    label_Banco_2 = ctk.CTkLabel(Viewer.tab("BPO"), text="Banco 2")
    entry_Banco_2 = ctk.CTkEntry(Viewer.tab("BPO"), width=50)

    label_Banco_2.grid(row=5, column=0, padx=10, pady=5, sticky="nsew")
    entry_Banco_2.grid(row=5, column=1, padx=10, pady=5, sticky="nsew")


    label_Tipo_de_BPO = ctk.CTkLabel(Viewer.tab("BPO"), text="Tipo de BPO")
    entry_Tipo_de_BPO = ctk.CTkEntry(Viewer.tab("BPO"), width=50)

    label_Tipo_de_BPO.grid(row=6, column=0, padx=10, pady=5, sticky="nsew")
    entry_Tipo_de_BPO.grid(row=6, column=1, padx=10, pady=5, sticky="nsew")
    ...
    label_Observaes_gerais.grid(row=7, column=0, padx=10, pady=5, sticky="nsew")
    entry_Observaes_gerais.grid(row=7, column=1, padx=10, pady=5, sticky="nsew")
