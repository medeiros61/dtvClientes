...
def parametrosinicias(frame,Frame_atual):
    ...
    bt_voltar = ctk.CTkButton(master_frame,text='< Voltar',command=RemovertelaEdit_MEI)
    ...
    bt_cancelar = ctk.CTkButton(master_frame,text='Cancelar',command=RemovertelaEdit_MEI)
