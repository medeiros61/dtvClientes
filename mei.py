...
def parametrosinicias(frame):
    ...
    bt_add_MEI = ctk.CTkButton(master=bt_action_frame,image=logo_add, text="Adicionair Contratante",command= Func_Mei.Adicionar_MEI_Contratante)
    bt_add_MEI.grid(row=0, column=0,  padx=5, pady=1,sticky="nsew")

    bt_add_MEI_Parceira = ctk.CTkButton(master=bt_action_frame,image=logo_add, text="Adicionair Parceira",command= Func_Mei.Adicionar_MEI_Parceira)
